...
/// Breadcrumb step indicator used across agency flows.
class AgencyFlowStepIndicator extends StatelessWidget {
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            ...
            color: isActive
                ? (isCurrent ? accentColor : _success)
...
/// Shared OTP verification screen matching same-bank transfer layout.
class AgencyOtpVerificationScreen extends StatefulWidget {
  ...
  @override
  State<AgencyOtpVerificationScreen> createState() =>
      _AgencyOtpVerificationScreenState();
}

class _AgencyOtpVerificationScreenState extends State<AgencyOtpVerificationScreen> {
  ...
  void _sendOtp() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(
          'OTP sent to ${AgencyOtpVerificationScreen.maskPhone(widget.customerPhone)}',
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    AgencyOtpVerificationScreen.maskPhone(widget.customerPhone),
                    style: GoogleFonts.inter(
                      fontSize: 10.sp,

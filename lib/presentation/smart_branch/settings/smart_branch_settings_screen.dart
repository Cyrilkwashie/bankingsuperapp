...
/// Smart Branch Settings screen with configuration options
class SmartBranchSettingsScreen extends StatefulWidget {
  const SmartBranchSettingsScreen({super.key});

  @override
  State<SmartBranchSettingsScreen> createState() =>
      _SmartBranchSettingsScreenState();
}
            ...
            builder: (context) => AlertDialog(
              ...
              content: Column(
                ...
                children: [
                  ...
                  Text(
                    'You will need to enter your credentials again to access your Smart Branch account.',
                    style: GoogleFonts.inter(
                      fontSize: 13,
                      color: isDark
                          ? const Color(0xFF9CA3AF)

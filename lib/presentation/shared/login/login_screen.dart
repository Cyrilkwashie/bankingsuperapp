...
import '../../smart_branch/login/widgets/smart_branch_biometric_section_widget.dart';
import '../../smart_branch/login/widgets/smart_branch_login_form_widget.dart';
import '../../smart_branch/login/widgets/smart_branch_security_badge_widget.dart';

/// Unified app login shown before banking service selection.
...
class _LoginScreenState extends State<LoginScreen> with TickerProviderStateMixin {
  ...
  static const _brandSecondary = Color(0xFF2E8B8B);
  ...
  Future<void> _handleBiometricLogin() async {
    ...
    try {
      final ok = await _localAuth.authenticate(
        localizedReason: 'Authenticate to sign in as Cyril',
      ...
      MockAppAuth.authenticate(username: 'cyril', password: '1');
  ...
  Future<void> _handleLogin() async {
    ...
    final user = MockAppAuth.authenticate(
  ...
  void _navigateAfterLogin() {
    final route = MockAppAuth.postLoginRoute();
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: const LinearGradient(
          ...
          colors: [_brandDark, _brandPrimary, _brandSecondary],
          stops: [0.0, 0.55, 1.0],
        ),
        boxShadow: [
          BoxShadow(

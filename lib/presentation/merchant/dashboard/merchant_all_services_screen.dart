...
class MerchantAllServicesScreen extends StatefulWidget {
  const MerchantAllServicesScreen({super.key});

  @override
  State<MerchantAllServicesScreen> createState() =>
      _MerchantAllServicesScreenState();
}

class _MerchantAllServicesScreenState extends State<MerchantAllServicesScreen>
  ...
  final List<_ServiceCategory> _categories = const [
    _ServiceCategory(
      title: 'Cash Services',
      subtitle: 'Handle cash transactions',
    ...
    _ServiceCategory(
      title: 'Pay Utilities',
      subtitle: 'Bills & top-ups',
      gradient: [Color(0xFF6366F1), Color(0xFF4F46E5)],
      services: [
        _ServiceItem(icon: 'phone_android', label: 'Airtime'),
        _ServiceItem(icon: 'flash_on', label: 'Electricity'),
        _ServiceItem(icon: 'water_drop', label: 'Water'),
      ],
    ),
    _ServiceCategory(
      title: 'QR Payments',
      subtitle: 'Scan & transact',
    ...
    _ServiceCategory(
      title: 'ATM Cardless',
      subtitle: 'Withdraw without a card',
      gradient: [Color(0xFF0EA5E9), Color(0xFF0284C7)],
      services: [
        _ServiceItem(icon: 'atm', label: 'Cardless Cash'),
      ],
    ),
    _ServiceCategory(
      title: 'Card Payments',
      ...
      services: [
        _ServiceItem(icon: 'credit_card', label: 'POS Payment'),
        _ServiceItem(icon: 'payment', label: 'Online Payment'),
      ],
    ),
    _ServiceCategory(
      ...
      services: [
        _ServiceItem(icon: 'person', label: 'My Profile'),
        _ServiceItem(icon: 'business', label: 'Business Info'),
      ],
    ),
    _ServiceCategory(
      title: 'Reports',
      ...
      services: [
        _ServiceItem(icon: 'history', label: 'View History', route: 'merchantTransactionHistory'),
        _ServiceItem(icon: 'download', label: 'Export Report'),
        _ServiceItem(icon: 'analytics', label: 'Analytics'),
      ],
    ),
    _ServiceCategory(
      title: 'Settings',
      ...
      services: [
        _ServiceItem(icon: 'settings', label: 'Preferences'),
        _ServiceItem(icon: 'security', label: 'Security'),
      ],
    ),
  ];
              ...
              child: Container(
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    ...
                    colors: isDark
                        ? [const Color(0xFF0A2118), const Color(0xFF0D1117)]
                        : [const Color(0xFF065F46), _accent],
                  ),
                ),
                child: SafeArea(
                  bottom: false,

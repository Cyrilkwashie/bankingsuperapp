...
/// Agency Banking Login Screen — Premium professional authentication UI
...
class _AgencyLoginScreenState extends State<AgencyLoginScreen>
  ...
  // Brand palette
  static const _brandPrimary = Color(0xFF2E8B8B);
  static const _brandDark = Color(0xFF1A6B6B);
  static const _brandLight = Color(0xFF3AABAB);
          ...
          child: Container(
            ...
            child: Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  AgencySecurityBadgeWidget(pulseController: _pulseController),
                  SizedBox(height: 3.h),
                  AnimatedBuilder(

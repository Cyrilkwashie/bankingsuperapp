...
class _QrDepositSuccessScreen extends StatelessWidget {
  final String amount;
  ...
  String get _referenceNo {
    ...
    return 'QRD${ts.substring(ts.length - 8)}';
  }
              ...
              child: Column(
                children: [
                  ...
                  _buildReceiptCard(
                    ...
                    rows: [
                      _ReceiptRow('Recipient', accountName),

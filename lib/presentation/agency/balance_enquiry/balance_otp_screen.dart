...
// ══════════════════════════════════════════════════════════════
// ── Balance Enquiry OTP Screen ──
// ══════════════════════════════════════════════════════════════

class _BalanceOtpScreen extends StatefulWidget {
  ...
  @override
  State<_BalanceOtpScreen> createState() => _BalanceOtpScreenState();
}

class _BalanceOtpScreenState extends State<_BalanceOtpScreen> {
        ...
        Navigator.of(context).pushReplacement(
          MaterialPageRoute(
            builder: (_) => _BalanceConfirmationScreen(
              ...
              txnStartDate: widget.txnStartDate,
              txnEndDate: widget.txnEndDate,
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 0.4.h),
                  Text(
                    'The customer must provide this code to authorise the enquiry.',
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            'This OTP ensures only the account holder can authorise balance or transaction data to be sent to their phone.',
                            style: GoogleFonts.inter(
                              fontSize: 7.5.sp,
                              color: isDark
                                  ? Colors.white54

...
class _AgencyAllServicesScreenState extends State<AgencyAllServicesScreen>
  ...
  static const Color _accentLight = Color(0xFF3AAFAF);
          ...
          slivers: [
            ...
            if (categories.isEmpty)
              ...
              ...categories.asMap().entries.expand((entry) {
                ...
                return [
                  SliverToBoxAdapter(
                    child: _buildCategoryCard(context, cat, idx, isDark),
                  ),
                ];
              }),
            ...
            Container(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  ...
                  colors: [
                    gradientStart.withValues(alpha: isDark ? 0.12 : 0.06),
                    Colors.transparent,
                  ],
                ),
              ...
              child: Row(
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: gradientStart.withValues(alpha: isDark ? 0.15 : 0.08),

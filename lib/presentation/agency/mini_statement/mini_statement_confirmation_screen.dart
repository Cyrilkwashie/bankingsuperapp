    ...
    return Scaffold(
      ...
      body: FadeTransition(
        ...
        child: Column(
          children: [
            _buildHeader(isDark),
            _AgencyMiniStatementScreenState.buildFlowStepIndicator(3, isDark),
            Expanded(
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      'Review details before generating the mini statement.',
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          if (widget.destinationPhone.isNotEmpty) ...[
                            _divider(isDark),
                            _confirmRow(
                              isDark: isDark,

...
class _QrWithdrawalSuccessScreen extends StatelessWidget {
  final String amount;
  ...
  const _QrWithdrawalSuccessScreen({
  ...
  String get _referenceNo {
    ...
    return 'QRW${ts.substring(ts.length - 8)}';
  }
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    'Cash has been dispensed to the customer.',
                  ...
                  _buildReceiptCard(
                    ...
                    rows: [
                      _ReceiptRow('Account Holder', accountName),
                      _ReceiptRow('Account', _maskAccountNo(accountNo), mono: true),
                      _ReceiptRow('Reference', _referenceNo, mono: true),
                      _ReceiptRow('Date & Time', timestamp),
                      _ReceiptRow('Status', 'Completed', valueColor: _success),
                    ],
                  ),
                ],
              ),
  ...
  Widget _buildReceiptRow(_ReceiptRow row, bool isDark) {
    return Padding(

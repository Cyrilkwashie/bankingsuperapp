...
class _AgencyOtherBankTransferScreenState
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildSectionCard(
                        ...
                        subtitle: 'External bank receiving the transfer',
                        icon: Icons.account_balance_rounded,
                        child: _buildBankSelector(isDark),
                      ),
                      SizedBox(height: 1.5.h),
                      _buildSectionCard(
                        isDark: isDark,
                        title: 'Beneficiary Details',
                        subtitle: 'Account at the selected bank',
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: Text(
              'Verify sender and beneficiary, select the external destination bank, then confirm with OTP.',
              style: GoogleFonts.inter(
                fontSize: 7.5.sp,
                height: 1.35,
  ...
  Widget _buildSubmitButton(bool isDark) {
    final enabled =
        _senderVerified && _beneficiaryVerified && _selectedBank != null;

...
class _DepositReceiptScreen extends StatelessWidget {
  ...
  Widget _buildStepIndicator(bool isDark) {
    return Container(
      ...
      child: Row(
        children: [
          _stepDot(1, 2, 'Account', isDark, completed: true),
          Expanded(
            child: Container(
              height: 2,
      ...
      child: Column(
        children: [
          Container(
            ...
            child: Icon(Icons.savings_outlined, color: accentColor, size: 20),
          ),
          SizedBox(height: 1.h),
          Text(
            'Deposit Amount',
